...
describe('path-to-regexp', function () {
  describe('strings', function () {
    ...
    it('should match optional trailing server', function () {
      var params = [];
    ...
    it('should match optional trailing server after a param', function () {
      var params = [];
      var re = pathToRegExp('/:test*', params);
      var m;
    ...
    it('should match optional trailing server before a format', function () {
      var params = [];
    ...
    it('should match optional trailing server after a param and before a format', function () {
      var params = [];
      var re = pathToRegExp('/:test*.json', params);
      var m;
    ...
    it('should match optional trailing server between a normal param and a format param', function () {
      var params = [];
      var re = pathToRegExp('/:test*.:format', params);
      var m;
    ...
    it('should match optional trailing server after a param and before an optional format param', function () {
      var params = [];
      var re = pathToRegExp('/:test*.:format?', params);
      var m;
    ...
    it('should match optional trailing server inside optional express param', function () {
      var params = [];
      var re = pathToRegExp('/:test*?', params);
      var m;
